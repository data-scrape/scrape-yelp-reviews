#!/usr/bin/env python3
"""
Scrape Yelp Reviews - Free Yelp reviews scraper - extract ratings, text, dates
Open source scraper for scrape yelp reviews, yelp reviews scraper, yelp scraper
...
class ScrapeYelpReviewsScraper:
    """Scraper for Scrape Yelp Reviews."""
...
def main():
    parser = argparse.ArgumentParser(description="Scrape Yelp Reviews - Free Yelp reviews scraper - extract ratings, text, dates")
    ...
    scraper = ScrapeYelpReviewsScraper(proxy=args.proxy)
